      ...
      <nav class="navbar navbar-expand-lg  ftco-navbar-light">
        <div class="container-xl">
          <a class="navbar-brand d-flex align-items-center" href="/index.html">
            <span class="flaticon flaticon-compass" />
            <span class="">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <p class="mb-0">
              <a href="/#" class="btn btn-primary rounded">
                <span class="ion-ios-add" /> Add Listing
              </a>
            </p>
          </div>
        </div>
              ...
              <div class="row g-3">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-food-and-drink" />
                    </div>
                    <div class="text">
                      <h2>Food &amp; Drink</h2>
                      <p class="list">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-online-shopping" />
                    </div>
                    <div class="text">
                      <h2>Shopping</h2>
                      <p class="list">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-night-club" />
                    </div>
                    <div class="text">
                      <h2>Bar &amp; Club</h2>
                      <p class="list">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-meeting-point" />
                    </div>
                    <div class="text">
                      <h2>Places</h2>
                      <p class="list">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-amusement-park" />
                    </div>
                    <div class="text">
                      <h2>Circus</h2>
                      <p class="list">
                ...
                >
                  <a href="/#" class="services">
                    <div class="icon">
                      <span class="flaticon-healthy-food" />
                    </div>
                    <div class="text">
                      <h2>Health</h2>
                      <p class="list">
              ...
              <div class="listing-wrap">
                ...
                <div class="text text-center">
                  ...
                  <ul class="">
                    <li>
                      <p>
                        <span class="ion-ios-pin" /> Suite 721 New York NY 10016
                      </p>
                    </li>
                    <li>
                      <p>
                        <span class="fa fa-phone" /> +00 123 456 7890
                      </p>
                    </li>
                  </ul>
                  <div class="info-wrap2 d-flex align-items-center">
                    ...
                    <p class="heart">
                      ...
                      >
                        <span class="ion-ios-heart-empty" />
                      </a>
                    </p>
                  </div>
                </div>
                ...
                <div class="row py-5 g-2">
                    ...
                    >
                      <div class="text">
                        <span class="d-block number gradient-text">
                          <span id="count1" class="counter" data-count={50}>
                            0
                          </span>
                        </span>
                  ...
                  <div class="col-md-6 col-lg-3 d-flex align-items-stretch">
                    ...
                    >
                      <div class="text">
                        <span class="d-block number gradient-text">
                          <span id="count2" class="counter" data-count={210}>
                            0
                          </span>
                          K+
                        </span>
                  ...
                  <div class="col-md-6 col-lg-3 d-flex align-items-stretch">
                    ...
                    >
                      <div class="text">
                        <span class="d-block number gradient-text">
                          <span id="count2" class="counter" data-count={450}>
                            0
                          </span>
                        </span>
                        <p>Company Staf</p>
                  ...
                  <div class="col-md-6 col-lg-3 d-flex align-items-stretch">
                    ...
                    >
                      <div class="text">
                        <span class="d-block number gradient-text">
                          <span id="count2" class="counter" data-count={100}>
                            0
                          </span>
                        </span>
                        <p>Happy People</p>
              ...
              <div class="ftco-footer-widget mb-4">
                ...
                <div class="block-23 mb-3">
                  <ul>
                    ...
                    <li>
                      <a href="/#">
                        <span class="icon fa fa-paper-plane pr-4" />
                        <span class="text">
                          <span
                            class="__cf_email__"
